  ...
  return (
    <Layout title="Safety profile | ZAYNICH" bodyClass="safety-profile-page">
      <div className="safety-profile">
        {/* Replace this placeholder with InsideBanner when the final artwork is supplied. */}
        <div className="safety-profile__banner" role="img" aria-label="Banner placeholder">
          <span>banner</span>
        </div>
        ...
        <section className="safety-profile__study" aria-labelledby="safety-profile-title">
          ...
          <div className="safety-profile__intro">
            <p>The safety of ZAYNICH was evaluated in a Phase 3 clinical trial in adults with<br className="safety-profile__desktop-break" /> complicated urinary tract infections (cUTI), including pyelonephritis.</p>
          </div>
        ...
        <section className="safety-profile__reactions" aria-labelledby="adverse-reactions-title">
          <h2 id="adverse-reactions-title">Most common adverse reactions</h2>
          ...
          <div className="safety-profile__table-wrap">
            <table aria-labelledby="adverse-reactions-title" aria-describedby="safety-profile-footnote safety-profile-comparison">
              <thead><tr><th scope="col">Adverse reaction</th><th scope="col">ZAYNICH (N=352)</th><th scope="col">Meropenem (N=177)</th></tr></thead>
              <tbody>
          ...
          <p className="safety-profile__comparison" id="safety-profile-comparison">Important: Trial 1 was not designed to evaluate meaningful comparisons of the incidence of adverse reactions between the ZAYNICH and meropenem treatment groups.</p>
        </section>
        <section className="safety-profile__discontinuations" aria-labelledby="discontinuations-title">
          <h2 className="safety-profile__pill" id="discontinuations-title">Discontinuations due to adverse reactions</h2>
          <p><span className="safety-profile__purple">1.4% (5/352)</span> of patients receiving ZAYNICH discontinued treatment due to an adverse reaction.</p>
          ...
          <p>Each occurred in 0.3% (1/352) of ZAYNICH-treated patients.</p>
        ...
        <section className="safety-profile__precautions" aria-labelledby="precautions-title">
          <div className="safety-profile__precautions-heading">
            <WarningIcon />
            <h2 className="safety-profile__pill" id="precautions-title">WARNINGS AND PRECAUTIONS</h2>
            <WarningIcon />
          </div>
          <div className="safety-profile__precautions-grid">
            <article className="safety-profile__hypersensitivity">
              ...
              <p>Serious hypersensitivity reactions, including anaphylaxis, have been reported in patients treated with ZAYNICH.</p>
              <p>Before initiating ZAYNICH, carefully inquire about previous hypersensitivity reactions to cefepime, cephalosporins, penicillins, or other beta-lactams because cross-hypersensitivity among beta-lactam antibacterial drugs has been reported.</p>
              <p>If an allergic reaction to ZAYNICH occurs, discontinue ZAYNICH and institute appropriate supportive measures.</p>
            </article>
            <article className="safety-profile__neurotoxicity">
              <h3><PrecautionIcon type="brain" /><span>Neurotoxicity</span></h3>
              <p>Neurotoxicity has been reported during treatment with cefepime,<br className="safety-profile__desktop-break" /> a component of ZAYNICH, including life-threatening or fatal occurrences.<br />Reported manifestations include:</p>
              <ul>
            ...
            <article className="safety-profile__infection">
              ...
              <p>Clostridioides difficile infection (CDI) has been reported with nearly all antibacterial agents, including ZAYNICH, and may range in severity from mild diarrhea to fatal colitis.</p>
        ...
        <section className="safety-profile__additional" aria-labelledby="additional-warnings-title">
          <h2 className="safety-profile__pill" id="additional-warnings-title">ADDITIONAL WARNINGS AND PRECAUTIONS</h2>
          <div className="safety-profile__warning-watermark"><WarningIcon /></div>
          <div className="safety-profile__additional-grid">
            <article className="safety-profile__additional-card">
              <h3>Positive direct Coombs’ tests</h3>
              <p>Positive direct Coombs’ tests, with or without hemolysis, have been reported during treatment with cefepime, a component of ZAYNICH.</p>
            </article>
            <article className="safety-profile__additional-card">
              <h3>Prolonged prothrombin time</h3>
            ...
            <article className="safety-profile__additional-card">
              <h3>Interactions with<br /> urine glucose testing</h3>
            ...
            <article className="safety-profile__additional-card">
              <h3>Development of<br /> drug-resistant bacteria</h3>
              <p>Prescribing ZAYNICH in the absence of a proven or strongly suspected bacterial infection or prophylactic indication is unlikely to provide benefit and increases the risk of developing drug-resistant bacteria.</p>
            </article>
          </div>
        </section>
        ...
        <section className="safety-profile__renal" aria-labelledby="renal-function-title">
          ...
          <div className="safety-profile__renal-copy">
            ...
            <p>Because neurotoxicity has been reported with cefepime and most cases occurred in patients with renal impairment who did not receive appropriate dosage adjustment, renal function and appropriate dosing should be considered when treating patients with ZAYNICH.</p>
          </div>
